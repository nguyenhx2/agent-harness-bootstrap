...
<p align="center">
  <img src="docs/assets/harness-loom.svg" alt="ハーネスを織機として描いた図: 左から生の意図がもつれた糸として入り、spec-builder があらゆる入力形式を一つの契約に変換する。ハーネスの枠の内側ではルールとフックが上からエージェントに降り、左から状態が、右からスキルが接続され、下へ順序立った三つの成果物が出ていく" width="960">
</p>
