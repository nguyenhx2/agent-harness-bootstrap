...
<p align="center">
  <img src="docs/assets/harness-view-assess.png" alt="harness-view の Assess タブ: 実際のハーネスを 100 点満点中 64 点と採点し、ボード健全性・コスト管理・ドキュメント品質・安全性・トレーサビリティのカテゴリ別バーと、問題を名指しする検出結果一覧を表示" width="900">
</p>

いずれもモックではなく実在のハーネスです。ノード 172、エッジ 505、決定的な assess エンジンに
よる採点は 64/100。この採点にモデルは一切関与しないため、ブラウザと CI が食い違うことは
ありません。
...
| | 導入前 | 導入後 | 差分 |
|---|---:|---:|---:|
| リポジトリをブートストラップするためにモデルが読むバイト数 | 234,196 | 152,164 | **-35%** |
