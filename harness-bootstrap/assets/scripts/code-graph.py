...
Outputs, from the repo root:
  .claude/state/code-graph.json   machine-readable: modules, files, edges, generated_at
...
def write_outputs(root: pathlib.Path, graph: dict) -> None:
    ...
    lines = [
        "# Code graph", "",
        f"Generated {graph['generated_at']} by `.claude/scripts/code-graph.py`. Do not edit by",
