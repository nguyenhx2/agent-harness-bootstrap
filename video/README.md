...
| 05 spec-builder | ~60s | [`mp4/05-spec-builder.mp4`](mp4/05-spec-builder.mp4) | [`html/05-spec-builder.html`](html/05-spec-builder.html) | spec-builder in depth, mirroring [`docs/FLOWS.md`](../docs/FLOWS.md) diagram 5: raw input, elicit, confirm the FR list FIRST, scaffold the selected sections - the core six always, fill in order, traceability check, and the rule that nothing is invented - anything unstated becomes a flagged AS-nn or OI-nn. |
...
| 07 skills and view | ~44s | [`mp4/07-skills-and-view.mp4`](mp4/07-skills-and-view.mp4) | [`html/07-skills-and-view.html`](html/07-skills-and-view.html) | The operating flow of [`docs/assets/harness-loom.svg`](../docs/assets/harness-loom.svg) end to end, then the step most kits skip - a roster of 7 to 15 of the 16 seats derived from the contract and the real modules, rather than everything installed up front - then the three mechanisms that keep it honest and the problem each one solves: Skill Discovery reads this project's manifests to find skills matching its stack, Skill Wire connects a chosen skill to the agent seat that needs it, and harness-view answers whether any of it is actually wired right. |
